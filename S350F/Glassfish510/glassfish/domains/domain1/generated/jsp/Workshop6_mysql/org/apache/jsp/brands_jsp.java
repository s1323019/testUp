...
public final class brands_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<html>\n");
      out.write("    <head> \n");
      out.write("        <title>All brands</title>\n");
      out.write("    </head>\n");
      out.write("    <body>  \n");
      out.write("       ");
  // using jsp action to get the brands from request 
      out.write("\n");
      out.write("         ");
      ...
      out.write("        ");
            ...
            for (int i = 0; i < brands.size(); i++) {
                ...
                out.println("<a href=\"getPhones?action=list&brand="+b.getName()+"\">"+b.getName()+"</a><br/>");
            }
