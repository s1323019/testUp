<%-- 
    ...
    Created on : 2023年11月29日, 下午6:20:39
    Author     : fg58hj123ty
--%>
...
<html>
    ...
    <body>
        ...
        <h3 style=" margin-left:5%;">List The Student Grade</h3>
            ...
            <table class="table table-hover" style="width:60%">
                <thead>
                    <tr>
                        ...
                        <th>Student ID </th>
                        <th>Gread</th>
                        <th>Score filling status</th>
                        <th>Edit/View</th>
                    </tr>
                </thead>
                <tbody id="studentTableBody">
                    <c:forEach items="${studentGradeList}" var="c"> 
                        <tr>
                            <td>${c.courseID}</td>
                            <td> ${c.studentID} </td>
                            <td>${c.grade}</td>
                            <td>${c.status}</td>
                            <td>
                                <a href="TeacherController?action=listScore&&id=${c.id}&&cid=${c.courseID}&&sid=${c.studentID}">
